...
public final class ScoredHand extends ArrayList<ScoredGroup> implements Serializable
{
	...
	public enum HandCompletedBy
	{
		...
		public final ScoreElement scoreElement;
		public final boolean forMahjong;

		private HandCompletedBy(boolean forMahjong, ScoreElement scoreElement)
		{
	...
	/** A Set of HandCompletedBy values that apply to this hand. */
